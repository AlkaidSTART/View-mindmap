...
import { Mail, Lock, ArrowRight, CircleUserRound } from "lucide-react";
        ...
        <div className="glass p-8 md:p-10 rounded-3xl shadow-2xl border border-white/10">
          ...
          <form className="space-y-6" onSubmit={(e) => e.preventDefault()}>
            ...
            <div className="flex items-center justify-between text-xs px-1">
              <label className="flex items-center gap-2 cursor-pointer">
                <input
                  type="checkbox"
                  className="rounded border-white/10 bg-white/5 text-brand-primary focus:ring-0"
                />
          ...
          <div className="mt-8">
            <div className="relative flex items-center justify-center mb-6">
              ...
              <span className="relative z-10 bg-transparent px-4 text-xs text-muted-foreground">
                或通过以下方式登录
              </span>
            </div>
            ...
            <button className="w-full flex items-center justify-center gap-3 bg-white/5 border border-white/10 hover:bg-white/10 text-white rounded-2xl py-3 text-sm font-medium transition-all">
              <CircleUserRound className="w-5 h-5" /> GitHub
            </button>
          </div>
