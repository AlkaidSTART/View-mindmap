...
export default function LandingPage() {
  ...
  return (
    <main className="relative min-h-screen bg-background text-foreground">
      ...
      {/* Hero Section */}
      <section ref={heroRef} className="relative pt-32 pb-20 px-6 max-w-7xl mx-auto overflow-hidden">
        <div className="text-center z-10 relative">
          ...
          >
            ...
            <span className="text-sm font-medium tracking-wide">AI 驱动的生产力革命</span>
          </motion.div>

          <h1 ref={titleRef} className="text-6xl md:text-8xl font-black tracking-tighter mb-8 leading-[1]">
            DOCUMENT <br />
          ...
          <p className="max-w-2xl mx-auto text-lg md:text-xl text-muted-foreground mb-12 leading-relaxed">
            AI Job Pilot 利用最先进的大型语言模型，将文档内容自动化转化为层级化的思维导图。
            从上传到生成，仅需数秒。
          </p>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            ...
            >
              立刻开始 <ChevronRight className="w-5 h-5 group-hover:translate-x-1 transition-transform" />
            </Link>
            <Link 
              href="/login" 
          ...
          <div className="bg-background/50 rounded-[2rem] aspect-video flex items-center justify-center relative overflow-hidden">
             ...
             <div className="flex flex-col items-center gap-4 text-center z-10">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground text-sm">支持 PDF, Word, Markdown, Text</p>
                </div>
             </div>
      ...
      <footer className="py-20 px-6 border-t border-white/5 bg-background/50">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center gap-8">
          <div className="flex items-center gap-2">
            ...
            <span className="font-bold text-xl tracking-tighter">AI Job Pilot</span>
          </div>
